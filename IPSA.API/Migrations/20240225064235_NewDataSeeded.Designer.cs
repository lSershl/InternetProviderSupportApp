...
namespace IPSA.API.Migrations
{
    ...
    [Migration("20240225064235_NewDataSeeded")]
            ...
            modelBuilder.Entity("IPSA.Models.AbonPageComment", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            Id = 1,
                            AbonentId = 1,
                            CommentDateTime = new DateTime(2024, 2, 25, 6, 42, 34, 682, DateTimeKind.Utc).AddTicks(6317),
                            EmployeeId = 1,
            ...
            modelBuilder.Entity("IPSA.Models.AbonentRequest", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            CreationDateTime = new DateTime(2024, 2, 25, 6, 42, 34, 682, DateTimeKind.Utc).AddTicks(6290),
                            Description = "Подкл. СПД через роутер абонента, документы выданы, кабеля нет, предв. позвонить",
                            EmployeeId = 1,
                            LastUpdateDateTime = new DateTime(2024, 2, 25, 6, 42, 34, 682, DateTimeKind.Utc).AddTicks(6291),
                            Status = "Открыта",
            ...
            modelBuilder.Entity("IPSA.Models.ConnectedTariff", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            Id = 1,
                            AbonentId = 1,
                            CreationDateTime = new DateTime(2024, 2, 25, 6, 42, 34, 682, DateTimeKind.Utc).AddTicks(6418),
                            IpAddress = "127.0.0.1",
                            IsBlocked = false,
                        ...
                        new
                        {
                            Id = 2,
                            AbonentId = 1,
                            CreationDateTime = new DateTime(2024, 2, 25, 6, 42, 34, 682, DateTimeKind.Utc).AddTicks(6437),
                            IpAddress = "127.0.0.1",
                            IsBlocked = false,
                            LinkToHardware = "(ссылка на мост к сетевому оборудованию)",
                            TariffId = 2
            ...
            modelBuilder.Entity("IPSA.Models.Employee", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            Login = "manager",
                            Password = "manager",
                            RegistrationDateTime = new DateTime(2024, 2, 25, 6, 42, 34, 682, DateTimeKind.Utc).AddTicks(6201),
                            ShortName = "Увалова А."
                        },
                        new
                        {
                            ...
                            Login = "techsup",
                            Password = "techsup",
                            RegistrationDateTime = new DateTime(2024, 2, 25, 6, 42, 34, 682, DateTimeKind.Utc).AddTicks(6222),
                        ...
                        new
                        {
                            ...
                            Login = "engineer",
                            Password = "engineer",
                            RegistrationDateTime = new DateTime(2024, 2, 25, 6, 42, 34, 682, DateTimeKind.Utc).AddTicks(6238),
                            ShortName = "Донских А."
                        });
                });
            ...
            modelBuilder.Entity("IPSA.Models.Payment", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            Comment = "тест",
                            ManagerId = 1,
                            PaymentDateTime = new DateTime(2024, 2, 25, 6, 42, 34, 682, DateTimeKind.Utc).AddTicks(6340),
            ...
            modelBuilder.Entity("IPSA.Models.Tariff", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            Id = 1,
                            Archived = false,
                            CreationDateTime = new DateTime(2024, 2, 25, 6, 42, 34, 682, DateTimeKind.Utc).AddTicks(6361),
                            DailyPrice = 13.4m,
                        ...
                        new
                        {
                            Id = 2,
                            Archived = false,
                            CreationDateTime = new DateTime(2024, 2, 25, 6, 42, 34, 682, DateTimeKind.Utc).AddTicks(6382),
                            DailyPrice = 6.7m,
                        ...
                        new
                        {
                            Id = 3,
                            Archived = false,
                            CreationDateTime = new DateTime(2024, 2, 25, 6, 42, 34, 682, DateTimeKind.Utc).AddTicks(6398),
                            DailyPrice = 50m,
