...
namespace IPSA.API.Migrations
{
    ...
    [Migration("20240304035205_ChangedFeeWithdrawModel")]
    partial class ChangedFeeWithdrawModel
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("IPSA.Models.AbonPageComment", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            Id = 1,
                            AbonentId = 1,
                            CommentDateTime = new DateTime(2024, 3, 4, 3, 52, 4, 787, DateTimeKind.Utc).AddTicks(6736),
                            EmployeeId = 1,
            ...
            modelBuilder.Entity("IPSA.Models.AbonentRequest", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            CreationDateTime = new DateTime(2024, 3, 4, 3, 52, 4, 787, DateTimeKind.Utc).AddTicks(6682),
                            Description = "Подкл. СПД через роутер абонента, документы выданы, кабеля нет, предв. позвонить",
                            EmployeeId = 1,
                            LastUpdateDateTime = new DateTime(2024, 3, 4, 3, 52, 4, 787, DateTimeKind.Utc).AddTicks(6683),
                            Status = "Открыта",
            ...
            modelBuilder.Entity("IPSA.Models.ConnectedTariff", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            Id = 1,
                            AbonentId = 1,
                            CreationDateTime = new DateTime(2024, 3, 4, 3, 52, 4, 787, DateTimeKind.Utc).AddTicks(6842),
                            IpAddress = "127.0.0.1",
                            IsBlocked = false,
                        ...
                        new
                        {
                            Id = 2,
                            AbonentId = 1,
                            CreationDateTime = new DateTime(2024, 3, 4, 3, 52, 4, 787, DateTimeKind.Utc).AddTicks(6862),
                            IpAddress = "127.0.0.1",
                            IsBlocked = false,
                            LinkToHardware = "(ссылка на мост к сетевому оборудованию)",
                            TariffId = 2
                        ...
                        new
                        {
                            Id = 3,
                            AbonentId = 2,
                            CreationDateTime = new DateTime(2024, 3, 4, 3, 52, 4, 787, DateTimeKind.Utc).AddTicks(6877),
                            IpAddress = "127.0.0.1",
                            IsBlocked = false,
                            LinkToHardware = "(ссылка на мост к сетевому оборудованию)",
                            TariffId = 3
            ...
            modelBuilder.Entity("IPSA.Models.Employee", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            Login = "manager",
                            Password = "manager",
                            RegistrationDateTime = new DateTime(2024, 3, 4, 3, 52, 4, 787, DateTimeKind.Utc).AddTicks(6569),
                            ShortName = "Увалова А."
                        },
                        new
                        {
                            ...
                            Login = "techsup",
                            Password = "techsup",
                            RegistrationDateTime = new DateTime(2024, 3, 4, 3, 52, 4, 787, DateTimeKind.Utc).AddTicks(6589),
                        ...
                        new
                        {
                            ...
                            Login = "engineer",
                            Password = "engineer",
                            RegistrationDateTime = new DateTime(2024, 3, 4, 3, 52, 4, 787, DateTimeKind.Utc).AddTicks(6605),
                            ShortName = "Донских А."
                        });
                });
            ...
            modelBuilder.Entity("IPSA.Models.FeeWithdraw", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            AbonentId = 1,
                            Amount = 400m,
                            CompletionDateTime = new DateTime(2024, 3, 4, 3, 52, 4, 787, DateTimeKind.Utc).AddTicks(6898),
                            ConnectedTariffId = 1,
                        ...
                        new
                        {
                            ...
                            AbonentId = 1,
                            Amount = 200m,
                            CompletionDateTime = new DateTime(2024, 3, 4, 3, 52, 4, 787, DateTimeKind.Utc).AddTicks(6914),
                            ConnectedTariffId = 2,
                            PricingModel = "Месячный",
                            Type = "Списание"
                        },
                        new
                        {
                            ...
                            AbonentId = 2,
                            Amount = 50m,
                            CompletionDateTime = new DateTime(2024, 3, 4, 3, 52, 4, 787, DateTimeKind.Utc).AddTicks(6930),
                            ConnectedTariffId = 3,
            ...
            modelBuilder.Entity("IPSA.Models.Payment", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            Comment = "тест",
                            ManagerId = 1,
                            PaymentDateTime = new DateTime(2024, 3, 4, 3, 52, 4, 787, DateTimeKind.Utc).AddTicks(6763),
            ...
            modelBuilder.Entity("IPSA.Models.Tariff", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            Id = 1,
                            Archived = false,
                            CreationDateTime = new DateTime(2024, 3, 4, 3, 52, 4, 787, DateTimeKind.Utc).AddTicks(6784),
                            DailyPrice = 13.4m,
                        ...
                        new
                        {
                            Id = 2,
                            Archived = false,
                            CreationDateTime = new DateTime(2024, 3, 4, 3, 52, 4, 787, DateTimeKind.Utc).AddTicks(6804),
                            DailyPrice = 6.7m,
                        ...
                        new
                        {
                            Id = 3,
                            Archived = false,
                            CreationDateTime = new DateTime(2024, 3, 4, 3, 52, 4, 787, DateTimeKind.Utc).AddTicks(6821),
                            DailyPrice = 50m,
