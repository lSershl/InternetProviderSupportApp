...
namespace IPSA.API.Migrations
{
    ...
    [Migration("20240306063823_ChangedAbonRequestModel")]
    partial class ChangedAbonRequestModel
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("IPSA.Models.AbonPageComment", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            Id = 1,
                            AbonentId = 1,
                            CommentDateTime = new DateTime(2024, 3, 6, 6, 38, 21, 909, DateTimeKind.Utc).AddTicks(2698),
                            EmployeeId = 1,
            ...
            modelBuilder.Entity("IPSA.Models.AbonentRequest", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            CreationDateTime = new DateTime(2024, 3, 6, 6, 38, 21, 909, DateTimeKind.Utc).AddTicks(2666),
                            Description = "Подкл. СПД через роутер абонента, документы выданы, кабеля нет, предв. позвонить",
                            EmployeeId = 1,
                            LastUpdateDateTime = new DateTime(2024, 3, 6, 6, 38, 21, 909, DateTimeKind.Utc).AddTicks(2666),
                            Status = "Открыта",
            ...
            modelBuilder.Entity("IPSA.Models.ConnectedTariff", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            Id = 1,
                            AbonentId = 1,
                            CreationDateTime = new DateTime(2024, 3, 6, 6, 38, 21, 909, DateTimeKind.Utc).AddTicks(2814),
                            IpAddress = "127.0.0.1",
                            IsBlocked = false,
                        ...
                        new
                        {
                            Id = 2,
                            AbonentId = 1,
                            CreationDateTime = new DateTime(2024, 3, 6, 6, 38, 21, 909, DateTimeKind.Utc).AddTicks(2873),
                            IpAddress = "127.0.0.1",
                            IsBlocked = false,
                            LinkToHardware = "(ссылка на мост к сетевому оборудованию)",
                            TariffId = 2
                        ...
                        new
                        {
                            Id = 3,
                            AbonentId = 2,
                            CreationDateTime = new DateTime(2024, 3, 6, 6, 38, 21, 909, DateTimeKind.Utc).AddTicks(2889),
                            IpAddress = "127.0.0.1",
                            IsBlocked = false,
                            LinkToHardware = "(ссылка на мост к сетевому оборудованию)",
                            TariffId = 3
            ...
            modelBuilder.Entity("IPSA.Models.Employee", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            Login = "manager",
                            Password = "manager",
                            RegistrationDateTime = new DateTime(2024, 3, 6, 6, 38, 21, 909, DateTimeKind.Utc).AddTicks(2553),
                            ShortName = "Увалова А."
                        },
                        new
                        {
                            ...
                            Login = "techsup",
                            Password = "techsup",
                            RegistrationDateTime = new DateTime(2024, 3, 6, 6, 38, 21, 909, DateTimeKind.Utc).AddTicks(2575),
                        ...
                        new
                        {
                            ...
                            Login = "engineer",
                            Password = "engineer",
                            RegistrationDateTime = new DateTime(2024, 3, 6, 6, 38, 21, 909, DateTimeKind.Utc).AddTicks(2589),
                            ShortName = "Донских А."
                        });
                });
            ...
            modelBuilder.Entity("IPSA.Models.FeeWithdraw", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            AbonentId = 1,
                            Amount = 400m,
                            CompletionDateTime = new DateTime(2024, 3, 6, 6, 38, 21, 909, DateTimeKind.Utc).AddTicks(2913),
                            ConnectedTariffId = 1,
                        ...
                        new
                        {
                            ...
                            AbonentId = 1,
                            Amount = 200m,
                            CompletionDateTime = new DateTime(2024, 3, 6, 6, 38, 21, 909, DateTimeKind.Utc).AddTicks(2930),
                            ConnectedTariffId = 2,
                            PricingModel = "Месячный",
                            Type = "Списание"
                        },
                        new
                        {
                            ...
                            AbonentId = 2,
                            Amount = 50m,
                            CompletionDateTime = new DateTime(2024, 3, 6, 6, 38, 21, 909, DateTimeKind.Utc).AddTicks(2944),
                            ConnectedTariffId = 3,
            ...
            modelBuilder.Entity("IPSA.Models.Payment", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            Comment = "тест",
                            ManagerId = 1,
                            PaymentDateTime = new DateTime(2024, 3, 6, 6, 38, 21, 909, DateTimeKind.Utc).AddTicks(2730),
            ...
            modelBuilder.Entity("IPSA.Models.Tariff", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            Id = 1,
                            Archived = false,
                            CreationDateTime = new DateTime(2024, 3, 6, 6, 38, 21, 909, DateTimeKind.Utc).AddTicks(2753),
                            DailyPrice = 13.4m,
                        ...
                        new
                        {
                            Id = 2,
                            Archived = false,
                            CreationDateTime = new DateTime(2024, 3, 6, 6, 38, 21, 909, DateTimeKind.Utc).AddTicks(2776),
                            DailyPrice = 6.7m,
                        ...
                        new
                        {
                            Id = 3,
                            Archived = false,
                            CreationDateTime = new DateTime(2024, 3, 6, 6, 38, 21, 909, DateTimeKind.Utc).AddTicks(2794),
                            DailyPrice = 50m,
