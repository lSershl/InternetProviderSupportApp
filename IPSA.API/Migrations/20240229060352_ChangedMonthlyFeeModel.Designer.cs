...
namespace IPSA.API.Migrations
{
    ...
    [Migration("20240229060352_ChangedMonthlyFeeModel")]
    partial class ChangedMonthlyFeeModel
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("IPSA.Models.AbonPageComment", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            Id = 1,
                            AbonentId = 1,
                            CommentDateTime = new DateTime(2024, 2, 29, 6, 3, 52, 10, DateTimeKind.Utc).AddTicks(8571),
                            EmployeeId = 1,
            ...
            modelBuilder.Entity("IPSA.Models.AbonentRequest", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            CreationDateTime = new DateTime(2024, 2, 29, 6, 3, 52, 10, DateTimeKind.Utc).AddTicks(8542),
                            Description = "Подкл. СПД через роутер абонента, документы выданы, кабеля нет, предв. позвонить",
                            EmployeeId = 1,
                            LastUpdateDateTime = new DateTime(2024, 2, 29, 6, 3, 52, 10, DateTimeKind.Utc).AddTicks(8543),
                            Status = "Открыта",
            ...
            modelBuilder.Entity("IPSA.Models.ConnectedTariff", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            Id = 1,
                            AbonentId = 1,
                            CreationDateTime = new DateTime(2024, 2, 29, 6, 3, 52, 10, DateTimeKind.Utc).AddTicks(8686),
                            IpAddress = "127.0.0.1",
                            IsBlocked = false,
                        ...
                        new
                        {
                            Id = 2,
                            AbonentId = 1,
                            CreationDateTime = new DateTime(2024, 2, 29, 6, 3, 52, 10, DateTimeKind.Utc).AddTicks(8706),
                            IpAddress = "127.0.0.1",
                            IsBlocked = false,
                            LinkToHardware = "(ссылка на мост к сетевому оборудованию)",
                            TariffId = 2
                        ...
                        new
                        {
                            Id = 3,
                            AbonentId = 2,
                            CreationDateTime = new DateTime(2024, 2, 29, 6, 3, 52, 10, DateTimeKind.Utc).AddTicks(8721),
                            IpAddress = "127.0.0.1",
                            IsBlocked = false,
                            LinkToHardware = "(ссылка на мост к сетевому оборудованию)",
                            TariffId = 3
            ...
            modelBuilder.Entity("IPSA.Models.Employee", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            Login = "manager",
                            Password = "manager",
                            RegistrationDateTime = new DateTime(2024, 2, 29, 6, 3, 52, 10, DateTimeKind.Utc).AddTicks(8428),
                            ShortName = "Увалова А."
                        },
                        new
                        {
                            ...
                            Login = "techsup",
                            Password = "techsup",
                            RegistrationDateTime = new DateTime(2024, 2, 29, 6, 3, 52, 10, DateTimeKind.Utc).AddTicks(8454),
                        ...
                        new
                        {
                            ...
                            Login = "engineer",
                            Password = "engineer",
                            RegistrationDateTime = new DateTime(2024, 2, 29, 6, 3, 52, 10, DateTimeKind.Utc).AddTicks(8471),
                            ShortName = "Донских А."
                        });
                });
            ...
            modelBuilder.Entity("IPSA.Models.Payment", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            Comment = "тест",
                            ManagerId = 1,
                            PaymentDateTime = new DateTime(2024, 2, 29, 6, 3, 52, 10, DateTimeKind.Utc).AddTicks(8597),
            ...
            modelBuilder.Entity("IPSA.Models.Tariff", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            Id = 1,
                            Archived = false,
                            CreationDateTime = new DateTime(2024, 2, 29, 6, 3, 52, 10, DateTimeKind.Utc).AddTicks(8619),
                            DailyPrice = 13.4m,
                        ...
                        new
                        {
                            Id = 2,
                            Archived = false,
                            CreationDateTime = new DateTime(2024, 2, 29, 6, 3, 52, 10, DateTimeKind.Utc).AddTicks(8644),
                            DailyPrice = 6.7m,
                        ...
                        new
                        {
                            Id = 3,
                            Archived = false,
                            CreationDateTime = new DateTime(2024, 2, 29, 6, 3, 52, 10, DateTimeKind.Utc).AddTicks(8662),
                            DailyPrice = 50m,
